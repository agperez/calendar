...
describe EventsController do
  ...
  let(:valid_attributes) { { "date" => "2014-02-14" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested event" do
        ...
        Event.any_instance.should_receive(:update).with({ "date" => "2014-02-14" })
        put :update, {:id => event.to_param, :event => { "date" => "2014-02-14" }}, valid_session
      end
