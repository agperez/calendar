...
describe SermonsController do
  ...
  let(:valid_attributes) { { "book" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sermon as @sermon" do
        ...
        post :create, {:sermon => { "book" => "invalid value" }}, valid_session
        assigns(:sermon).should be_a_new(Sermon)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sermon" do
        ...
        Sermon.any_instance.should_receive(:update).with({ "book" => "MyString" })
        put :update, {:id => sermon.to_param, :sermon => { "book" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sermon as @sermon" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sermon.any_instance.stub(:save).and_return(false)
        put :update, {:id => sermon.to_param, :sermon => { "book" => "invalid value" }}, valid_session
        assigns(:sermon).should eq(sermon)
      end
